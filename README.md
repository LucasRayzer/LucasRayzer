...
Engenhario de Software graduado pela UDESC-CEAVI.</br>
Atualmente estou buscando novas oportunidades de atuar no mercado, seja em desenvolvimento ou em pesquisas.</br>
Atuei um ano em um projeto de pesquisa intitulado como "Projeto Automático de Algorítmos", o projeto de algoritmos de otimização e inteligência artificial consistia na seleção e combinação de componentes algorítmicos, e na configuração dos seus parâmetros de entrada. No segundo semestre do projeto desenvolvi estudos na área de Análises de Redes, na qual o centro CEAVI foi objeto de estudo, analisando alguns dos aspectos da rede de coautoria entre professores deste centro da UDESC.</br>
Atuei um ano e três meses como estagiário no Escritório Modelo de Pesquisa e Desenvolvimento de Software (EMPDS), onde participei de projetos como desenvolvedor PHP full-stack.
...
<div style= "display: inline_block"><br> 
       ...
       <img alt="html5" src="https://img.shields.io/badge/GitLab-330F63?style=for-the-badge&logo=gitlab&logoColor=white" />
</div><br/>
